  ...
  return (
    <div className="border bg-[white] box-border flex justify-center items-start flex-col gap-8 self-stretch grow-0 shrink-0 basis-auto px-8 py-6 rounded-lg border-solid border-[#e4e7ec]">
      <div className="box-border flex justify-start items-start flex-row gap-8 self-stretch grow-0 shrink-0 basis-auto">
        {/* title */}
        <h2 className="h-6 min-w-[778px] [font-family:Satoshi] text-xl font-bold tracking-[-0.40px] text-left leading-6 box-border grow shrink basis-auto pl-0 border-[none] text-[#1d2739]" >Quote Information</h2>
        {/* Date */}
        <p className="[font-family:Satoshi] text-sm font-normal text-[#667185] grow-0 shrink-0 basis-auto m-0 p-0">Expected delivery date : 2024-12-02</p>
      </div>
      {/* Details */}
